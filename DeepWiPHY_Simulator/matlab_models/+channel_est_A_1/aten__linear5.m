classdef aten__linear5 < nnet.layer.Layer & nnet.layer.Formattable & ...
    ...
    methods
        ...
        function [linear_9, linear_9_rank] = predict(obj,linear_input_1, linear_input_1_rank)
            ...
            [linear_input_1, linear_input_1_format] = channel_est_A_1.ops.permuteToReversePyTorch(linear_input_1, '', numel(linear_input_1_rank));
        ...
        function [linear_9] = tracedPyTorchFunction(obj,linear_input_1,isForward,predict)
            ...
            [linear_9] = channel_est_A_1.ops.pyLinear(linear_input_1, linear_weight_1, linear_bias_1);
        end
